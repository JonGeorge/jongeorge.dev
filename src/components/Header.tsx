...
function MobileNavLink(
    ...
    return (
        <motion.div whileHover={{fontWeight: "bold"}}>
            <PopoverButton
                as={Link}
                className="block text-base/7 tracking-tight text-gray-700 dark:text-gray-300 w-fit"
                {...props}
            />
        </motion.div>
    )
...
export function Header() {
    ...
    return (
        <header
            className={`fixed top-0 left-0 right-0 transition-all duration-500 ${scrolled ? "bg-white/90 dark:bg-neutral-950/90 py-2" : "bg-transparent py-4"}`}>
            <nav>
                                        ...
                                        {open && (
                                            <>
                                                <PopoverBackdrop
                                                    ...
                                                    animate={{opacity: 1}}
                                                    exit={{opacity: 0}}
                                                    className="fixed inset-0 z-0 bg-white/50 dark:bg-neutral-950/50 backdrop-blur-xs"
                                                />
                                                <PopoverPanel
                                                    static
                                                    as={motion.div}
                                                    ...
                                                    className="absolute top-15 inset-x-0 z-0 origin-top rounded-b-2xl bg-white/90 dark:bg-neutral-950/90 px-6 pt-10 pb-6 shadow-2xl shadow-gray-900/20 dark:shadow-gray-900/20"
                                                >
                        ...
                        <div className="flex gap-3">
                            ...
                            >
                                <Link
                                    ...
                                    <LinkedInIcon className="h-7 w-7 text-gray-900 dark:text-white"/>
                                </Link>
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                <Link href="https://github.com/JonGeorge"
                                      target="_blank" rel="noopener noreferrer">
                                    <GitHubIcon className="h-7 w-7 text-gray-900 dark:text-white"/>
                                </Link>
                            </motion.div>

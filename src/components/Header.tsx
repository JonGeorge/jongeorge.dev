...
function LinkedInIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
    return (
        <svg viewBox="0 0 480 480" fill="black" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" {...props}>
                                            ...
                                            <>
                                                ...
                                                >
                                                    <div className="space-y-4">
                                                        ...
                                                        <MobileNavLink href="/#accomplishments">
                                                            Impact
                                                        </MobileNavLink>
                                                        <MobileNavLink href="/#my_role">
                                                            My Role
                                                        </MobileNavLink>
                                                    </div>
                                                    <div className="mt-8 flex  gap-4">
                                                        <Link href="https://www.linkedin.com/in/jon-georgex/" target="_blank" rel="noopener noreferrer">
                                                            <LinkedInIcon className="h-7 w-7"/>
                                                        </Link>
                                                        <Link href="https://github.com/JonGeorge" target="_blank" rel="noopener noreferrer">
